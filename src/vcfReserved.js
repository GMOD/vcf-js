/**
 * The INFO fields that are reserved in the VCF spec.
 */
...
/**
 * The FORMAT fields that are reserved in the VCF spec.
 */
export const GenotypeFields = {
  // from the VCF4.3 spec, https://samtools.github.io/hts-specs/VCFv4.3.pdf
  AD: {
    Number: 'R',
    Type: 'Integer',
...
/**
 * A The ALT fields that are reserved in the VCF spec.
 */
...
/**
 * The ALT fields that are reserved in the VCF spec.
 */
